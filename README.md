...
```
bash <(curl -Ls https://raw.githubusercontent.com/yxdz2020/x-ui/master/install.sh)
```  
如果你的系统版本比较老旧，安装后报错：GLIBC_2.28 not found，请使用如下命令安装0.3.3.9版本
```  
bash <(curl -Ls https://raw.githubusercontent.com/yxdz2020/x-ui/master/install.sh) 0.3.3.9  
```  
